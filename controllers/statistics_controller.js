...
/*
    # de preguntas
    # de comentarios totales
    # medio de comentarios por pregunta
    # de preguntas sin comentarios
    # de preguntas con comentarios
*/
exports.show = function(req,res){
  ...
  models.Quiz.findAll({
    ...
    res.render('statistics/index', {quizes: _quizes,
                                      comments: _comments,
